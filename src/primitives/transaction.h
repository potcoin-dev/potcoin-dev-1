...
#ifndef KEKCOIN_PRIMITIVES_TRANSACTION_H
#define KEKCOIN_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    static const int32_t POSV_TRANSACTION_VERSION=3;
...
#endif // KEKCOIN_PRIMITIVES_TRANSACTION_H
